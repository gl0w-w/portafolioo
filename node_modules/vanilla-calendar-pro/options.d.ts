...
import { AnimationOptions, DateAny, DateMode, DatesArr, Labels, Layouts, Locale, MonthsCount, Popups, PositionToInput, Range, Styles, ThemesDefault, TimeControl, ToggleSelected, TypesCalendar, WeekDayID, WeekDays } from './types';
